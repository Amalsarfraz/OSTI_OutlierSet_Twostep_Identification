...
n_datasets = 40
n_per_shape = 10 # Datasets per shape
n_datapoints = 1500
n_outliers = 150
...
#=======================================give folder path here=========================
    folder_path = f"Case2_datasets/{transform_name}"
...
output_folder_path = 'Case2_datasets/Case2_FINAL_result_pickles'
#========================Update path accordingly==============================
...
plt.savefig(f'{output_folder_path}/case2_param1vs2.png', dpi=1200, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'{output_folder_path}/heatmap_OSTI_Case2.png', dpi=1200)
plt.close()
